...
from One_bit_vit_weight import *
import utils
...
def get_args_parser():
    ...
    parser.add_argument('--teacher_p', type=str, default='')
    ...
    # Dataset parameters /datasets01/imagenet_full_size/061417/
    ...
    parser.add_argument('--output_dir', default='/opt/data/private/ob_vit/result_stage1',
...
def main(args):
   ...
   # print(args)
    ...
    model = onebits_deit_small_patch16_224_w32(
        config,
